...
Public Class ucSkinButton
    ...
    Public Sub LoadImages(ByVal path_ico As String, StartupPath As String)
        Dim bmp As Bitmap
        Try
            bmp = Image.FromFile(StartupPath + "\" + path_ico)
            ...
            If IO.File.Exists(StartupPath + "\" + Mid(path_ico, 1, path_ico.Length - 4) + "_negative.png") Then
                bmp = New Bitmap(StartupPath + "\" + Mid(path_ico, 1, path_ico.Length - 4) + "_negative.png")
            End If
        ...
        End Try
    End Sub
    Public Sub LoadImages(ByVal path_normal As String, ByVal path_move As String, ByVal path_down As String, ByVal path_ico As String, StartupPath As String)
        Try
            Picture.normal = Image.FromFile(StartupPath + "\" + path_normal)
            Picture.mouse_move = Image.FromFile(StartupPath + "\" + path_move)
            Picture.mouse_down = Image.FromFile(StartupPath + "\" + path_down)
            Dim bmp As Bitmap = Image.FromFile(StartupPath + "\" + path_ico)
    ...
    Private Sub ucSkinButton_Load(sender As Object, e As EventArgs) Handles MyBase.Load
