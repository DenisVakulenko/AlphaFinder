...
#Region "AfterResizing"
    ...
    Private Sub ResizeAll()
        ...
        ImagesBox.Left = 6
        ImagesBox.Top = picResize.Top + picResize.Height
        ImagesBox.Height = Me.ClientRectangle.Height - picResize.Top - picResize.Height - 6
        ImagesBox.Width = Me.ClientRectangle.Width - 12
...
#End Region
    ...
    Private Sub Form1_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Try
            'pnlWait.BackgroundImage = BG_Loading
    ...
    Private Sub picResize_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles picResize.DoubleClick 'picResize.Click 
        If picResize.Top = 31 Then
            'picResize.Top = DirsBoxHeight
            ShowDirsBox()
        Else
            HideDirsBox()
        End If
        'DirsBoxHeight = picResize.Top : picResize.Top = 31
        'ResizeAll()
    End Sub
...
#Region "Buttons events"
    ...
    Private Sub btnOrder_Click() Handles btnOrder.Click
        ImagesBox.OrderImages()
    End Sub
    Private Sub btnRnd_Click() Handles btnRnd.Click
...
#End Region
    ...
    Private Sub ImagesBox_SendFocusToTheTop() Handles ImagesBox.SendFocusToTheTop
        If picResize.Top = 31 Then
            If DirsBox.NDirs > 0 Then ShowDirsBox()
        Else
            DirsBox.Select()
        End If
    End Sub
    Private Sub DirsBox_SendFocusToTheBottom() Handles DirsBox.SendFocusToTheBottom
        If ImagesBox.NImages > 0 Then ImagesBox.Select()
    End Sub
    ...
    Private Sub DirsBox_SendFocusToTheBottom(ByRef Done As System.Boolean) Handles DirsBox.SendFocusToTheBottom
